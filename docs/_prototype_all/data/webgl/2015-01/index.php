...
<p>GLSL / blender</p>
<ul>
<li><a href="./2014/" title="2014年度習作一覧です">2014 - <span>archives</span></a></li>
</ul>
<ol>
<?php
$fileArray = Array();
if ($dir = opendir("./")) {
    while (($file = readdir($dir)) !== false) {
        if ($file != "." && $file != ".." && $file != "index.html" && $file != "index.php" && $file != "js" && $file != "img" && $file != "secret" && $file != "2014" && $file != "sound") {
            $fileArray[] = $file;
        }
    } 
    closedir($dir);
    ...
    foreach ( $fileArray as $key => $value )
    {
        ...
        echo "<li><a href=\"./".$value."/\" title=\"".$description."\">".$value." - <span>".$keywords."</span></a></li>\n";
    } 
}
?>
</ol>
