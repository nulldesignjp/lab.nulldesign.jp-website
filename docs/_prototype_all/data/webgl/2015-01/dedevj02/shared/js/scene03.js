...
var scene03 = (function () {
    function scene03(_camera, _focus, _sky) {
    ...
    scene03.prototype.createSphere = function () {
        var _t = this;
    ...
    scene03.prototype.createLine = function () {
        var _t = this;
    ...
    scene03.prototype.rnd = function () {
        return Math.random() * 2 - 1;
    };
    scene03.prototype.createTriangle = function () {
    ...
    scene03.prototype.update = function () {
        var _t = this;
    ...
    scene03.prototype.interactive = function (_type, _data) {
        var _t = this;
        if (_type == 'kinect') {
    ...
    scene03.prototype.effects = function () {
        var _t = this;
    ...
    scene03.prototype.dispose = function () {
        var _t = this;
        kill(_t.scene);
        function kill(e) {
