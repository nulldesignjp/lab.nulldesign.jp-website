...
(function(){
	...
	world3d.resolution = {width:window.innerWidth,height:window.innerHeight};

	world3d.ZERO = new THREE.Vector3(0, 0, 0);
	world3d.time = Date.now();
	...
	world3d.uniforms.resolution.value.x = world3d.resolution.width;
	world3d.uniforms.resolution.value.y = world3d.resolution.height;
	...
	var three = (function(){
		...
		three.prototype = 
		{
			_init	:	function( container )
			{
				...
				this.scene.fog = new THREE.Fog( this.fog, 500, 2000 );
			...
			addEvents	:	function()
			{
				...
				window.addEventListener( 'resize', function(e){
					...
					world3d.resolution = {width:_width,height:_height};
				}, false );
