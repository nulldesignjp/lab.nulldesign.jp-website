...
(function(){
	...
	{
		// _position[ i * 3 + 0 ] = ( Math.random() - .5 ) * BOUNDS * 2.0;
		// _position[ i * 3 + 1 ] = ( Math.random() - .5 ) * BOUNDS * 2.0;
		// _position[ i * 3 + 2 ] = ( Math.random() - .5 ) * BOUNDS * 2.0;

		var _rad0 = Math.random() * Math.PI * 2.0;
		var _rad1 = Math.random() * Math.PI * 2.0;

		_position[ i * 3 + 0 ] = - Math.cos( _rad1 ) * Math.cos( _rad0 ) * BOUNDS;
		_position[ i * 3 + 1 ] = Math.sin( _rad0 ) * BOUNDS;
		_position[ i * 3 + 2 ] = Math.sin( _rad1 ) * Math.cos( _rad0 ) * BOUNDS;
...
//
	...
	function animate()
	{
		...
		if( isView ){	_renderer.render( _scene2, _camera2 ); }
		//
