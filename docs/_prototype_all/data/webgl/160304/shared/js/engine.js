...
var Practice = (function(){
	...
	function Practice()
	{
		...
		this.world.scene.fog = new THREE.Fog( 0xFFFFFF, 1600, 3200 );
		...
		this.world.controls.maxDistance = 3200;
		...
		var _gh = new THREE.GridHelper( 10000, 100 );
		this.world.add( _gh );
		_gh.position.y = -300;
		...
		this.world.add( _box );
		var edges = new THREE.EdgesHelper( _box, 0x33CC33 );
		this.world.add( edges );

		var _t = this;
		(function looop(){
			_box.position.y = Math.sin( _t.clock.elapsedTime ) * 100 + 200;
		...
		_loader.load( 'shared/img/circle0.png',function(texture){
			...
			for( var i = 0; i < _len; i++ )
			{
				...
				var _r = ( 1.0 - Math.random() * Math.random() ) * 800 + 800;
