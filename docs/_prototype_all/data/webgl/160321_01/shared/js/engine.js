...
var Practice = (function(){
	...
	function Practice()
	{
		...
		this.uniforms = {
			...
			baseColor: {type:'c',value:new THREE.Color(0.2,0.6,0.9)}
		};
		...
		function create( texture )
		{
			...
			for( var i = 0; i < len * 3 * 3; i++ )
			{
				...
				var _rad0 = Math.random() * Math.PI * 2.0;
				var _rad1 = Math.random() * Math.PI * 2.0;
				var _r0 = Math.random() * 200 * _distScale + 16;
				...
				_vector[ i * 3 * 3 + 0 ] = Math.random() * Math.PI * 2.0;
				_vector[ i * 3 * 3 + 1 ] = Math.random() * Math.PI * 2.0;
				_vector[ i * 3 * 3 + 2 ] = Math.random() * 20;

				_vector[ i * 3 * 3 + 3 ] = Math.random() * Math.PI * 2.0;
				_vector[ i * 3 * 3 + 4 ] = Math.random() * Math.PI * 2.0;
				_vector[ i * 3 * 3 + 5 ] = Math.random() * 20;

				_vector[ i * 3 * 3 + 6 ] = Math.random() * Math.PI * 2.0;
				_vector[ i * 3 * 3 + 7 ] = Math.random() * Math.PI * 2.0;
				_vector[ i * 3 * 3 + 8 ] = Math.random() * 20;
			}

			for( var i = 0; i < len * 3; i++ )
			{
				_index[ i * 3 + 0 ] = Math.random();
				_index[ i * 3 + 1 ] = Math.random();
				_index[ i * 3 + 2 ] = Math.random();
			}
