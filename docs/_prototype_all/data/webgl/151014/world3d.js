...
(function (world3d) {
    ...
    var three = (function () {
        function three(container) {
            ...
            this.scene.fog = new THREE.Fog(0x181818, 1000, 3200);
            this.camera = new THREE.PerspectiveCamera(35, _width / _height, 0.1, 3200);
    ...
    var basicEvents = (function () {
        function basicEvents(_camera, _renderer) {
            ...
            window.addEventListener('resize', function (e) {
                ...
                world3d.uniforms.resolution.value.y = _height;
            }, false);
            window.addEventListener('mousemove', function (e) {
                world3d.mouse.x = e.pageX;
                world3d.mouse.y = e.pageY;
                world3d.uniforms.mouse.value.x = world3d.mouse.x / window.innerWidth;
                world3d.uniforms.mouse.value.y = (window.innerHeight - world3d.mouse.y) / window.innerHeight;
                e.preventDefault();
            }, false);
