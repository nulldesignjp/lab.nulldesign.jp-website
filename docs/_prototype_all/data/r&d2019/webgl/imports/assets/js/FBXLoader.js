...
( function () {
	...
	function parseMaterial( FBXTree, materialNode, textureMap, connections ) {
		...
		switch ( type.toLowerCase() ) {
			...
			case 'phong':
				//material = new THREE.MeshPhysicsMaterial();
			...
			case 'lambert':
				...
				break;
			default:
				console.warn( 'THREE.FBXLoader: unknown material type "%s". Defaulting to MeshLambertMaterial.', type );
				material = new THREE.MeshLambertMaterial( { color: 0x3300ff } );
				break;
		}
