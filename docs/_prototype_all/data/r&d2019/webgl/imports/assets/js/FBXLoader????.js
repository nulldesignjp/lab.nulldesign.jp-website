...
( function () {
	...
	function parseMaterial( FBXTree, materialNode, textureMap, connections ) {
		...
		//	custom
		//	console.log( name, parameters, FBXTree, materialNode, textureMap, connections )
		console.log( name, materialNode )

		function toBoolean (data) {
			return data.toLowerCase() === 'true';
		}

		if ( materialNode.transparent ) {

			parameters.transparent = toBoolean( materialNode.transparent.value );

		}
		if ( materialNode.opacity ) {

			parameters.opacity = materialNode.opacity.value;
