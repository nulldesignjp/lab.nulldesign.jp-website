...
var world = (function(){
	...
	world.prototype = {
		init : function( e )
		{
			...
			this.scene.fog = new THREE.Fog( 0x333333, 800, 1600 );

			this.camera = new THREE.PerspectiveCamera(50, width / height, 0.1, 1600 );
			...
			//	this.composer.addPass(new THREE.BloomPass(1.0, 25, 1.0, 512));
